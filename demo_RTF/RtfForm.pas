...
var
  ...
  RtfHigh:integer=0; //Jak 0 to domyœlne wartoœci ustawione w formularzu
  RtfWidth:integer=0;//Jak 0 to domyœlne wartoœci ustawione w formularzu
  GoButtonCaption:string='';//Jak pusty to domyœlne wartoœci ustawione w formularzu
